...
export type ProfileSection = "personal" | "professional" | "preferences" | "jobApplication" | "resume";
...
export const CATEGORY_POLICIES: Record<EmailCategory, CategoryPolicy> = {
  job_application: {
    ...
    profileSections: ["personal", "professional", "jobApplication", "resume", "preferences"],
  ...
  leave_request: {
    value: "leave_request",
    label: "Leave Request",
    profileSections: ["personal", "professional", "preferences"],
  ...
  complaint: {
    value: "complaint",
    label: "Complaint",
    profileSections: ["personal", "preferences"],
